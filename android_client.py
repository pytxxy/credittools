...
TEST_DEBUG_CONFIG = {
    ...
    'req_name': 'test',
    'req_passwd': 'Test',
    'req_url': 'http://192.168.20.118:9008/api/flow',
...
def get_args(src_args=None):
    ...
    parser.add_argument('--req_url', metavar='req_url', dest='req_url', default='http://10.192.2.90:9008/api/flow', help='request url')
