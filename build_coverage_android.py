...
class BuildManager(build_base.BuildManager):
    def _get_pro_build_config(self):
        ...
        output_directory = os.path.join(output_directory, time_str)
...
def get_args(src_args=None):
    ...
    parser.add_argument('--verenv', metavar='ver_env', dest='ver_env', type=str, default='normal', choices=['normal'],
                        help='normal: tool application, no environment configure;')
