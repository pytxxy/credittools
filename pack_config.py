...
def get_args(src_args=None):
    ...
    parser.add_argument('--app', metavar='app_code', dest='app_code', type=str, default=_APP_CODE_TXXY, choices=[_APP_CODE_TXXY, _APP_CODE_XYCX, _APP_CODE_PYQX, _APP_CODE_PYZX], help='app code name')
