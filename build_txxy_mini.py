...
def get_args(src_args=None):
    ...
    parser.add_argument('--verenv', metavar='ver_env', dest='ver_env', default='test',
                        choices=['dev', 'test', 'pre', 'pregray', 'gray', 'pro'],
    ...
    parser.add_argument('--nsremote', dest='sub_remote', action='store_false', default=True,
                        help='not pull submodule remote update')
