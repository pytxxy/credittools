...
class BuildManager:
    ...
    def build(self, param_map):
        ...
        str_format_tail = '--include_bitcode true --clean --configuration {configuration} --archive_path {archive_path} --export_method {export_method} --output_directory {output_directory} --output_name {output_name} --export_options {export_options} --export_xcargs {export_xcargs}'
        item_format = '--{} {{{}}}'
